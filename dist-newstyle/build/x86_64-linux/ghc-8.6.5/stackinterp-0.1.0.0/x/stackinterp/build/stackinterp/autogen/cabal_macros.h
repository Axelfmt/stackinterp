...
/* package stackinterp-0.1.0.0 */
#ifndef VERSION_stackinterp
#define VERSION_stackinterp "0.1.0.0"
#endif /* VERSION_stackinterp */
#ifndef MIN_VERSION_stackinterp
#define MIN_VERSION_stackinterp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_stackinterp */
...
#define CURRENT_COMPONENT_ID "stackinterp-0.1.0.0-inplace-stackinterp"
